...
최근 **한국형사정책연구원(2022)** 조사에 따르면,  
폭력범죄 피해가 가장 많이 발생하는 시간대는 **오후 6시부터 자정(18:00–24:00)** 으로 나타났습니다.  
또한 성인 여성의 **63%**가 야간 보행 시 성폭력·성희롱 피해를 걱정한다고 응답했습니다.  

한편, **고령층(60세 이상)** 의 범죄 가해자 비중은 10년 전(2014년) 약 **8.8%**에서  
2024년 약 **18.8%**로 크게 증가했습니다.  
...
| AI 분석 | **LLM API (예: OpenAI 기반)** *(추후 적용)* |
